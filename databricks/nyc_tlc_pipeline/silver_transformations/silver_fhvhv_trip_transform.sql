create or refresh materialized view ${project.catalog_name}.${project.silver_schema}.fhvhv_trip_records
(
...
from ${project.catalog_name}.${project.bronze_schema}.fhvhv_trip_records
),
